...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "check_in", sa.String(), server_default=sa.text("now()"), nullable=True
        ),
        sa.PrimaryKeyConstraint("item_id"),
    )
    op.create_index(
        op.f("ix_inventory_item_id"), "inventory", ["item_id"], unique=False
    )
    op.create_index(
        op.f("ix_inventory_item_name"), "inventory", ["item_name"], unique=True
    )
    op.create_table(
        "menu",
    ...
    op.create_table(
        ...
        sa.Column(
            "order_date", sa.Date(), server_default=sa.text("now()"), nullable=True
        ),
